...
public class BigTraceRenderSettings implements Command {
	...
	private String dithering = sDitherChoices[Math.min(7,(int) Prefs.get("BigTrace.ditherWidth", RenderSettings.defDitherWidth))];
	...
	public void run() {
		...
		Prefs.set("BigTrace.ditherWidth", ditherWidth-1);
