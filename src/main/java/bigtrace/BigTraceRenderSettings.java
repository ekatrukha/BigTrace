...
@Plugin(type = Command.class, menuPath = "Plugins>BigTrace 0.2.1>Render Settings")
public class BigTraceRenderSettings implements Command {

	@Parameter( label = "Render width" )
	public int renderWidth = (int) Prefs.get("BigTrace.nRenderW",800.0);

	@Parameter( label = "Render height" )
	public int renderHeight = (int) Prefs.get("BigTrace.nRenderH",600.0);
	...
	public int maxCacheSizeInMB = 300;
	@Override
	public void run() {
