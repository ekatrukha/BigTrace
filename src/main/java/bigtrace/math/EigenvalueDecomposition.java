...
public class EigenvalueDecomposition<T extends RealType< T >> implements java.io.Serializable {
      ...
      for (int l = 0; l < n; l++) {
         ...
         if (m > l) {
            ...
            do {
               ...
               double r = EigenvalueDecomposition.hypot(p,1.0);
               if (p < 0) {
                  r = -r;
               }
               d[l] = e[l] / (p + r);
 ...
 * ------------------------ */
   ...
   */
   public EigenvalueDecomposition ( final int nDim )
   {
	   n=nDim;
	   V = new double[n][n];
       d = new double[n];
